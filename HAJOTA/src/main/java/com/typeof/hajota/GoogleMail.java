...
public class GoogleMail {
	...
	public void sendmail(String recipient, String certificationCode) 
		...
		// 제목설정
		String subject = "localhost:9090/hajota/ 사이트에서 회원님의 비밀번호 찾기를 위한 인증코드 발송"; 
		...
		public void sendmailbirth(String recipient) 
	       throws Exception {
		...
		//    우리는 Google gmail 를 사용하도록 하겠다.
		//    그러므로 gmail 계정이 있어야 한다.
		prop.put("mail.smtp.user", "khcs0710@gmail.com");
		...
		// 제목설정
		String subject = "(쿠폰) HAJOTA ★HAPPY BIRTHDAY EVENT★"; 
		msg.setSubject(subject);
		
		// 보내는 사람의 메일주소
		String sender = "khcs0710@gmail.com";
		Address fromAddr = new InternetAddress(sender);
		msg.setFrom(fromAddr);
		...
		// 메시지 본문의 내용과 형식, 캐릭터셋 설정하기
		msg.setContent("<span style='font-size:14pt; color:#ea6153;'>★HAPPY BIRTHDAY EVENT★</span> 고객님의 생일 맞이하여 생일축하 할인 쿠폰이 쿠폰함으로 발급되었습니다! <img src='http://vieclamhanquoc.vn/images/2017/03/25/chuc-mung-sinh-nhat-bang-tieng-han2.jpg' /> <img src='http://cfile231.uf.daum.net/image/180A61434E10840721E368' />", "text/html;charset=UTF-8"); 
