   ...
   <!-- Navigation Bar -->
    <div class="w3-bar w3-white w3-border-bottom w3-xlarge">
      <img
         ...
         <input type="text" id="search" name="search" placeholder="search" size="10" style="height: 30px;" />&nbsp; <label><i class="fa fa-male"></i></label>&nbsp;
      ...
      <c:if test="${sessionScope.loginuser != null }">
         <a
            style="color: red; font-weight: bold; font-size: 15px; margin-left: 100px;">
            환영합니다♥ </a>
         <a style="color: navy; font-weight: bold; font-size: 15px;">
            ${sessionScope.loginuser.LAST_NAME}${sessionScope.loginuser.FIRST_NAME}님
         </a>
      ...
      <a href="#"
         ...
         title="HOSTING"><i class="fa fa-globe"></i></a> <a href="#"
         class="w3-bar-item w3-button  w3-right w3-hide-small w3-padding-large"
         title="question"><i class="fa fa-question-circle"></i></a>

  		<a href="<%= request.getContextPath() %>/memberRegisterForm.go">회원가입</a>
		<a href="<%= request.getContextPath() %>/memberEdit.go">회원수정</a>

      <c:if test="${sessionScope.loginuser == null}">
         <a data-toggle="modal" data-target="#joinModal"
            class="w3-bar-item w3-button  w3-right w3-hide-small w3-padding-large"
            title="Join"><i class="fa fa-user-plus"></i></a>
       ...
       <c:if test="${sessionScope.loginuser != null}">
         ...
         <a href="<%=request.getContextPath()%>/editUser.go"
            ...
            <img src="<%=request.getContextPath()%>/resources/images/ISJW/user.png" width="40px;" height="40px;" />
         </a>
      </c:if> 
  ...
  <div class="body modal" id="pwdfindModal" role="dialog" style="width: 40%; margin-left: 27%; margin-top: 7%; background-color: none;">
    <div class="modal-dialog">
      ...
      <%-- <div class="modal-content" align="center">
        ...
        <div class="modal-body" style="height: 400px; width: 100%;">
          <div id="pwFind">
             <iframe style="border: none; width: 100%; height: 350px;" src="<%= request.getContextPath() %>/findpwd.go"></iframe>
          </div>
        </div>
