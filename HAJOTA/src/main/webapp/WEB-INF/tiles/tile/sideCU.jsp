	...
	<div class="col-md-3" style="border: solid 0px red; margin-left: -200px;">
		<div class="panel panel-default" style="border: solid 0px red; width: 99%; height:100%;">
			<div class="panel-body inbox-menu" style="width: 90%; height: 300px;">						
				...
				<ul>
					<li>
						<a href="<%=request.getContextPath()%>/callview.go"><i class="fa fa-inbox"></i> 콜센터 </a>
					</li>
					<li>
						<a href="<%=request.getContextPath()%>/questionList.go"><i class="fa fa-star"></i> Q&A<span class="label label-danger">3</span></a>
					</li>
					<li>
						<a href="<%=request.getContextPath()%>/FAQ.go"><i class="fa fa-rocket"></i> FAQ</a>
					</li>
					<li>
						<a href="<%=request.getContextPath()%>/chat.go"><i class="fa fa-trash-o"></i> 1:1 문의</a>
					</li>
