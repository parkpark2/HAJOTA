...
<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/TypeofCss/JH/prettyPhoto.css" />
...
<script src="<%=request.getContextPath() %>/resources/js/JH/jquery.easing.1.3.js"></script>
...
<script src="<%=request.getContextPath() %>/resources/js/JH/jquery.quicksand.js"></script>
