				...
				<!-- <div id="JH_roomsList_header_search_Halign"> -->
					...
					<div class="JH_search_dropdown_div">
						<dropdown id="JH_search_dropdown_calender"
							...
							id="JH_search_dropdown_toggle_numOfPerson" type="checkbox">
						...
						<ul class="JH_search_dropdown_animate">
							...
							<li class="JH_search_dropdown_animate" style="margin-left: -14.6%;">
								<div>
									...
									<div class="JH_numOfPeople_count_window">
										<div class="length-control">
										    <div class="length-control__wrap">
										        <p class="length-control__header">인원 수</p>
										        <a href="#" class="minus length-control__button">-</a>
										        <span class="length-control__number length-control__number__break">1</span>
										        <a href="#" class="plus length-control__button">+</a>
										    </div>
										</div>
									</div>
								</div>
					...
					<div class="JH_search_dropdown_div">
						<dropdown id="JH_search_dropdown_calender"
							class="JH_search_dropdown"> <input
							id="JH_search_dropdown_toggle_checkindate" type="checkbox">
...
<div class="content-wrapper">
  <div class="left-wrapper" style="border: solid 1px red;">
          ...
          <tr class="days" data-row="5">
            ...
            <td data-column="6"></td>
					...
					<div class="JH_search_dropdown_div">
						<dropdown id="JH_search_dropdown_calender"
							class="JH_search_dropdown"> <input
							id="JH_search_dropdown_toggle_checkoutdate" type="checkbox">
