...
<div id="skipDIV" style="margin-left:22%; margin-top: 1%; ">
...
<div id="myDIV" style="width:80%; height:10%; border: solid 0px red;"> 
   <video controls autoplay loop id="Video1" style="width:140%; height:30%; margin-top: -50px; margin-left: 100px; border: solid 0px red;">      
         <source src="<%= request.getContextPath() %>/resources/images/HSSH/동영상.mp4"/>        
   </video>
</div> 

<div id="content" style="border: solid 0px red; margin-left: 25px;">
