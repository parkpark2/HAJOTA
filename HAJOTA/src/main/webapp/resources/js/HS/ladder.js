$(function(){
    ...
    function userSetting(){
        ...
        for(var i=0; i <  userList.length; i++){
            ...
            html +='<div class="user-wrap" style="margin-left:'+left+'px;"><input type="hidden" value="꽝! 다시 도전하세요." data-node="'+userList[i]+'"><button class="ladder-start" style="background-color:'+color+'" data-color="'+color+'" data-node="'+userList[i]+'"></button>';
            html +='</div>'
            }
    ...
    function drawDefaultLine(){
        var html = '';
        html += '<table style="margin-top: -230px; margin-left:2px;">'
         for(var y =0; y < heightNode-1; y++){
            html += '<tr>';
            for(var x =0; x <widthNode-1 ; x++){
                html += '<td style="width:100px; height:27px; border-left:2px solid #ddd; border-right:2px solid #ddd;"></td>';
            }
            html += '</tr>';
        }
        html += '</table>'
